#include "../CreateLeveled.h"

namespace Dialog
{


CreateLeveled::CreateLeveled(Graphic::GlyphPtr glyphParent, MainWindow *parent)
...
void CreateLeveled::Create()
{
	emit CreateOver(new Graphic::LeveledExpression(parent_));
	close();
}
